...
public class TimBot { 
  ...
  /** 
     ...
     Params: spresso: a 5 element array of integers indicating when
             ...
             bots   : a 5 element array of booleanbs indicating whether
  ...
  //find the minimum amount of moves and returns it
  protected int findMinimum(int min, int [] scores, int move) {
