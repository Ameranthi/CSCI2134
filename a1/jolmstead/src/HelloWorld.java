...
public class HelloWorld {
    ...
    private static final String bannerNumber = "B00780639";

    // replace ???? with your csid (e.g., abrodsky)
    private static final String csid = "Jolmstead";

    // replace ???? with your last name (e.g., Brodsky)
    private static final String lastName = "Olmstead";

    // replace ???? with your last name (e.g., Alex)
    private static final String firstName = "Julia";
