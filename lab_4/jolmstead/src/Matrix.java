 ...
 * Defect 1:
 * Line 272
 * getWidth method return height- changed to return width
 * Time a couple of seconds
 *
 * Defect 2:
 * line 103
 * Unnessary semicolon after encapsulated code blocked -> {};
 * time: a couple of seconds
 *
 * Defect 3:
 * line 172
 * wrong variable used in the for loop -> was i needed to be j in method MultiplyWithScalar
 * Time: 2 minutes
 *
 * Defect 4
 * 126 negate method
 * reversed index areas ->  matrix[i][j] = -matrix[i][j];
 * time: 5 mins
 *
 * Defect 5:
 * ...
