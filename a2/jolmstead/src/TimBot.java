...
*/
public class TimBot { 
  protected int myId;                                  // TimBot's ID
  ...
  /** 
     ...
     array and a boolean array of 5 elements each is passed.

     The elements represent the state of the District.CURRENT district
   ...
   */
    ...
    energyLevel += jolts;
    if( energyLevel > 99 ) { // fixed the < sign to be >.
      energyLevel = 99;
    }
  }
