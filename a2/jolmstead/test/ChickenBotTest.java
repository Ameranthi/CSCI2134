...
class ChickenBotTest {
    ...
    ChickenBot cockadoodledoo = new ChickenBot(69, 96);
    ChickenBot theOneThatIsDead = new ChickenBot(11,-1);
    ...
    void getNextMove() {
        ...
        cockadoodledoo.senseDistricts(spresso, bots);
        ...
        //returns not null
        assertNotNull(cockadoodledoo.getNextMove());
        ...
        assertTrue(cockadoodledoo.isFunctional(), "This bot should still be functional");
    ...
    void getNextMoveEnergy(){
        ...
        cockadoodledoo.getNextMove();
        int energyAfterMove = cockadoodledoo.energyLevel;
        assertEquals(96, energyAfterMove, "energy was taken despite not moving from the current district");
